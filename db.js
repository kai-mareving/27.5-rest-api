const db = {
  testimonials:
    [
      ...
      { id: 3, author: 'Dorothy Vaughn', text: 'Every product is up to highest standards.' },
      { id: 4, author: 'Gawin Hopes', text: 'Best company of this year.' },
      { id: 5, author: 'Sylvia Ovens', text: 'Remarkable client service.' },
    ],
  concerts:
    [
      {
        id: 1, performer: 'John Doe', genre: 'Rock', price: 25, day: 1,
        image: '/img/uploads/1fsd324fsdg.jpg'
      },
      {
        id: 2, performer: 'Rebekah Parker', genre: 'R&B', price: 25, day: 1,
        image: '/img/uploads/2f342s4fsdg.jpg'
      },
      {
        id: 3, performer: 'Maybell Haley', genre: 'Pop', price: 40, day: 1,
